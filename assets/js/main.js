const translations = {
	de: {
		...
		ggst: {
			...
			overviewText3: "Für Rayven ist Guilty Gear mehr als ein Spiel – es ist eine Bühne, auf der Stil und Können zusammenfinden. Unsere Spieler pflegen die Community rund um Ranked-Matches, lokale Meetups und internationale Turniere und tragen die Farben von Rayven in jede Runde.",
		...
		valorant: {
			...
			overviewText3: "Für Rayven ist VALORANT die Bühne, auf der taktische Tiefe auf Teamgeist trifft. Unsere Roster trainiert regelmäßig, analysiert Gegner und tritt in Ligen und Turnieren an – immer mit dem Anspruch, gemeinsam zu wachsen.",
			releaseDateLabel: "RELEASE DATE",
		...
		silverpalace: {
			...
			overviewText3: "Für Rayven steht Silver Palace für unseren Anspruch, auch abseits kompetitiver Titel gemeinsam Geschichten zu erleben. Unsere Community begleitet Let's-Plays, Theorien und gemeinsame Durchläufe rund um dieses düstere Kapitel.",
			releaseDateLabel: "RELEASE DATE",
	...
	en: {
		...
		ggst: {
			...
			overviewText3: "For Rayven, Guilty Gear is more than a game — it's a stage where style and skill come together. Our players nurture the community around ranked matches, local meetups, and international tournaments, carrying Rayven's colors into every round.",
			releaseDateLabel: "RELEASE DATE",
		...
		valorant: {
			...
			overviewText3: "For Rayven, VALORANT is the stage where tactical depth meets team spirit. Our roster trains regularly, studies opponents, and competes in leagues and tournaments, always striving to grow together.",
			releaseDateLabel: "RELEASE DATE",
		...
		silverpalace: {
			...
			overviewText3: "For Rayven, Silver Palace represents our ambition to experience stories together beyond competitive titles. Our community follows let's-plays, theories, and shared playthroughs of this dark chapter.",
			releaseDateLabel: "RELEASE DATE",
	...
	ja: {
		...
		ggst: {
			breadcrumbGames: "ゲーム",
			breadcrumbCurrent: "ギルティギア ストライヴ",
			availability: "配信中",
			eyebrow: "妥協なき一騎討ち",
			title: "GUILTY GEAR -STRIVE-",
			subtitle: "スタイルと精密さが交わる場所",
			overviewTitle: "ゲーム概要",
			overviewText1: "GUILTY GEAR -STRIVE- は、Arc System Worksによる名作対戦格闘ゲームシリーズの最新作です。手描き風の背景、疾走感あるメタルサウンドトラック、そして独自のロマンキャンセルシステムが、爆発的なコンボと高い戦術的深みを融合させます。",
			overviewText2: "世界中のプレイヤーとのロールバックネットコード対戦でも、大規模な大会の舞台でも、-STRIVE-は読み合い・タイミング・精神力が勝敗を分ける妥協なき1対1の戦いを体現します。",
			overviewText3: "Rayvenにとってギルティギアは単なるゲームではなく、スタイルと実力が交わる舞台です。私たちの選手はランクマッチ、地域のミートアップ、国際大会を通じてコミュニティを育み、あらゆる試合でRayvenの色を背負って戦います。",
			releaseDateLabel: "発売日",
			releaseDateValue: "2021年6月11日",
			tagsLabel: "タグ",
			tag1: "対戦格闘",
			tag2: "1対1",
			tag3: "アニメ",
		...
		valorant: {
			breadcrumbGames: "ゲーム",
			breadcrumbCurrent: "ヴァロラント",
			availability: "配信中",
			eyebrow: "戦術と精密さの融合",
			title: "VALORANT",
			subtitle: "すべての判断が勝負を分ける場所",
			overviewTitle: "ゲーム概要",
			overviewText1: "VALORANTは、Riot Gamesによる5対5の戦術シューティングゲームです。精密な銘擦とエージェント固有の能力が融合し、各ラウンドでは明確なコミュニケーションと精神力が問われます。",
			overviewText2: "ランク戦でも大会の舘台でも、VALORANTは一体となって考え行動するチームに報いを与えます。連携された戦略と信頼のみが勝利へと導きます。",
			overviewText3: "RayvenにとってVALORANTは、戦術的な深みとチームワークが交わる舘台です。私たちのロスターは定期的に練習し、相手を分析し、リーグや大会に参戦しています。",
			releaseDateLabel: "発売日",
			releaseDateValue: "2020年6月2日",
			tagsLabel: "タグ",
			tag1: "FPS",
			tag2: "戦術",
			tag3: "5対5",
		...
		silverpalace: {
			breadcrumbGames: "ゲーム",
			breadcrumbCurrent: "シルバーパレス",
			availability: "配信中",
			eyebrow: "叫びよりも重い沈黙",
			title: "SILVER PALACE",
			subtitle: "二度と戻ってはいけない場所",
			overviewTitle: "ゲーム概要",
			overviewText1: "SILVER PALACEは、安価なジャンプスケアではなく心理的な恐怖に重きを置いた、彜囲気满点のシングルプレイホラー体験です。庺れて人気のない廊下と薄れゆく記憶の中で、物語が少しずつ明らかになっていきます。",
			overviewText2: "秘密に満ちた邸宅を探索し、すべての音が意味を持ち、すべての選択が結果をもたらします。緊張感と物語、そして決して安心できないという感覚に重きを置いています。",
			overviewText3: "RayvenにとってSilver Palaceは、対戦タイトル以外でも仲間と物語を共有するという私たちの姿勢を表しています。コミュニティは実況プレイや考察、共同プレイを通じてこの暗い物語を見守っています。",
			releaseDateLabel: "発売日",
			releaseDateValue: "発売予定",
			tagsLabel: "タグ",
			tag1: "ホラー",
			tag2: "物語",
			tag3: "シングルプレイ",
